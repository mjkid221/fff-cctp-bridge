...
import { useUnreadCount, useToggleNotificationPanel, useIsNotificationPanelOpen } from "~/lib/notifications";
      ...
      <AnimatePresence>
        {unreadCount > 0 && (
          <motion.div
            ...
            animate={{ scale: 1 }}
            exit={{ scale: 0 }}
            className="absolute -right-1 -top-1 flex size-5 items-center justify-center rounded-full bg-blue-500 text-[10px] font-bold text-white shadow-lg"
          >
